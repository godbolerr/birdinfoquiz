...
<link rel="shortcut icon" href="http://bidcinsights.appspot.com/images/bankicon.jpg">
...
<body data-twttr-rendered="true"
	...
	<div id="body-container">
		...
		<div id="header-container">
			<header class="cf">
				...
				<div id="header-widget-area" class="widget-area"
					...
					<div id="pc_info_widget_designfolio-pro-2"
						...
						<img
							...
							alt="Facebook" height="32" width="32"><img
				...
				<c:if test="${fn:indexOf(fn:toLowerCase(pageURL),'registration') > 0 || profile != null}">
	    			...
	    			<c:set var="pageHeading" value="Let's begin the journey together...."/>
	  			</c:if>
	  			...
	  			<c:if test="${fn:indexOf(pageURL,'share') > 0}">
	    			...
	    			<c:set var="pageHeading" value="Share your feedback with friends..."/>
	  			</c:if>
		...
		<footer>
			...
			<div id="site-info">
				<p class="copyright">&copy; 2014 <a href="http://bidcinsights.appspot.com/"
