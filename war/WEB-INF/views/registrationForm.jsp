					...
					<div id="post-187"
						...
						<div class="post-content" style="padding-left: 0px;">
							...
							<div align="center">
								...
								<form action='<c:url value="/submitRegistration.do"/>'
									method="post">
									<table border="1">
										<tr>
											<td>Email</td>
											<td><input type="text" size="25" name="email" id="email"
												value='<c:out value="${profile.email}"/>' /></td>
										</tr>
										<tr>
											<td>Name</td>
										...
										<tr>
											<td>Date of Birth</td>
											<td><input type="text" size="25" name="dob" id="dob"
												value="" /></td>
										</tr>
										<tr>
											<td>Country</td>
											<td><input type="text" size="25" name="country"
												id="country" value='<c:out value="${profile.country}"/>' /></td>
										</tr>
										<tr>
											<td>Language</td>
											<td><input type="text" size="25" name="language"
												id="language" value='<c:out value="${profile.language}"/>' /></td>
										</tr>
										<tr>
											<td>Gender</td>
											<td><input type="text" size="25" name="gender"
												id="gender" value='<c:out value="${profile.gender}"/>' /></td>
										</tr>
										<tr>
											<td>Location</td>
											<td><input type="text" size="25" name="location"
												id="location" value='<c:out value="${profile.location}"/>' /></td>
										</tr>
										<tr>
											<td>Profile Image</td>
